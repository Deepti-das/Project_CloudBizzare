...
CREATE TABLE production.product (
	...
	FOREIGN KEY (supplier_id ) REFERENCES production.supplier (supplier_id ) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE sales.employee (
	...
	FOREIGN KEY (manager_id) REFERENCES sales.Employee (Employee_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);

-- Order status: 1 = Pending; 2 = Processing; 3 = Rejected; 4 = Completed
CREATE TABLE sales.order_status (
	order_status_id tinyint IDENTITY (1, 1) PRIMARY KEY,
